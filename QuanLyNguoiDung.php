...
<head>
  ...
  <title>ContestOnline &mdash;</title>
</head>
<body>
      ...
      <div class="menu-bg-wrap">
        <div class="site-navigation">
          <div class="row g-0 align-items-center">
            <div class="col-2">
              <a href="index.html" class="logo m-0 float-start">Quản Lý Người Dùng<span class="text-primary">.</span></a>
            </div>
            <div class="col-8 text-center ">
              <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu mx-auto">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="TaoDeThi.html">Tạo Đề Thi</a></li>
                    <li class="active"><a href="QuanLyNguoiDung.html">Quản Lý Người Dùng</a></li>
                ...
                <li class="active"><a href="TaoCuocThi.html">Tạo Cuộc Thi</a></li>
