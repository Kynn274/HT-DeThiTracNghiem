...
class initDatabase extends Database
{
    public function create_structure()
    {
        ...
        // Tạo bảng Question với độ khó, chủ đề, và dạng câu hỏi
        $sql = "CREATE TABLE IF NOT EXISTS Question (
            QuestID INT(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
            qDescription TEXT NOT NULL,
            qAnswer VARCHAR(255) NOT NULL,
            qTopic VARCHAR(50) NOT NULL COMMENT 'Phân loại theo chủ đề',
            qFormat ENUM('Trắc nghiệm', 'Điền khuyết', 'Ghép nối', 'Tự luận') NOT NULL COMMENT 'Dạng câu hỏi',
            qDifficulty ENUM('1', '2', '3') NOT NULL COMMENT '1=Dễ, 2=Trung, 3=Khó',
            qType VARCHAR(50) NOT NULL COMMENT 'Loại câu hỏi theo dạng'
        )";
        $this->set_query($sql);
        $this->excute_query();
