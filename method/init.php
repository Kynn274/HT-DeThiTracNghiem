<?php
    ...
    $tableQueries = [
        ...
        "CREATE TABLE IF NOT EXISTS UserDetails(
	        [UserDetailID] INT PRIMARY KEY IDENTITY(1,1), -- Mã thông tin người dùng
	        ...
	        [Evidence] VARCHAR, -- Xác nhận nghề nghiệp
        ...
        "CREATE TABLE IF NOT EXISTS QuestionBanks(
	        [QuestionBankID] INT PRIMARY KEY IDENTITY(1,1), -- Mã ngân hàng câu hỏi
        ...
        "CREATE TABLE Questions(
	        [QuestionID] INT PRIMARY KEY IDENTITY(1,1), -- Mã câu hỏi
        ...
        "CREATE TABLE Answers(
	        [AnswerID] INT PRIMARY KEY IDENTITY(1,1), -- Mã đáp án
        ...
        "CREATE TABLE IF NOT EXISTS Contests(
	        ...
	        [ScorePerQuestion] AS 10 / [TotalQuestions], -- Số điểm 1 câu hỏi
        ...
        "CREATE TABLE IF NOT EXISTS JoiningContests(
	        [JoiningContestID] INT PRIMARY KEY IDENTITY(1,1), -- Mã cuộc thi tham gia
        ...
        "CREATE TABLE IF NOT EXISTS ScoreTables(
	        [ScoreTableID] INT PRIMARY KEY IDENTITY(1,1), -- Mã bảng điểm
	        [JoiningContestID] INT NOT NULL, -- Mã cuộc thi tham gia
